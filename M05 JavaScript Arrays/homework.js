...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   // una forma mas simple es poner return palabras.join(" "); (COMPRENDER BIEN LA LOGICA DETRAS DEL JOIN!!)
   var palabraUnida;
...
function empiezaConNueve(num) {
   ...
   // Tu código:  metodo corto return str[0] === "9";
...
function mesesDelAño(array) {
   ...
   // Tu código: investigar metodo map
